...
ErkeScan currently tracks futures data from three major exchanges:

- **Binance Futures** — the most liquid crypto derivatives market
- **Bybit** — linear perpetual contracts
- **Hyperliquid** — decentralized perpetual exchange

## Quick Start

Ready to get started? Head to [Create Your Account](getting-started/create-your-account.md) and you'll be up and running in under 5 minutes.
